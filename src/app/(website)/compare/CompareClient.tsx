...
const comparisonRows = [
    ...
    { label: "মডিউল সংখ্যা", key: "modulesCount" as const, icon: <LayersIcon size={16} color="var(--color-neutral-400)" /> },
];

type RowKey = (typeof comparisonRows)[number]["key"];

function getValue(c: CompareCourse, key: RowKey): string {
    switch (key) {
        case "duration": return c.duration;
        case "type": return c.type;
        case "category": return c.category || "—";
        case "feeAdmission": return c.feeAdmission;
        case "feeTotal": return c.feeTotal;
        case "feeScholarship": return c.feeScholarship;
        case "modulesCount": return `${c.modulesCount}টি মডিউল`;
        default: return "";
    }
}
...
export default function CompareClient({ courses }: { courses: CompareCourse[] }) {
