...
import {
    ...
    ScissorsIcon, ShoeIcon, CarIcon, BookIcon,
...
function getRecommendations(courses: QuizCourse[], answers: Record<string, string>): QuizCourse[] {
    ...
    if (answers.budget === "free") {
        courses.forEach((c) => {
            if (c.feeTotal.includes("বিনামূল্যে") || c.feeTotal.includes("ফ্রি")) scores[c.slug] += 15;
        });
    }
...
export default function QuizClient({ courses }: { courses: QuizCourse[] }) {
    ...
    const recommendations = useMemo(() => {
        ...
        return getRecommendations(courses, answers);
    }, [showResults, answers, courses]);
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={styles.resultMeta}>
                                                    ...
                                                    <span>{course.feeScholarship}</span>
                                                </div>
