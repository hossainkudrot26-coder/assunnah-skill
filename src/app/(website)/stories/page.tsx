...
import { MessageCircleIcon, AwardIcon } from "@/shared/components/Icons";
import styles from "./stories.module.css";

export const metadata: Metadata = {
    title: "সাফল্যের গল্প",
    description: "আমাদের সফল শিক্ষার্থীদের অনুপ্রেরণামূলক গল্পসমূহ",
};

const stories = [
    {
        name: "আব্দুল্লাহ আল মামুন", batch: "স্মল বিজনেস ম্যানেজমেন্ট — ব্যাচ ৩", initials: "আম",
        ...
        achievement: "নিজের অনলাইন ব্যবসা", color: "#1B8A50",
    },
    {
        name: "ফাতেমা খাতুন", batch: "স্মার্ট টেইলারিং — ব্যাচ ২", initials: "ফখ",
        ...
        achievement: "নিজস্ব টেইলারিং ব্যবসা", color: "#AD1457",
    },
    {
        name: "মোহাম্মদ হাসান", batch: "শেফ ট্রেনিং — ব্যাচ ১", initials: "মহ",
        ...
        achievement: "রেস্টুরেন্ট শেফ হিসেবে কর্মরত", color: "#E65100",
    },
    {
        name: "রাহিমা বেগম", batch: "সেলস ও মার্কেটিং — ব্যাচ ১", initials: "রব",
        ...
        achievement: "মার্কেটিং এক্সিকিউটিভ", color: "#1565C0",
    },
    {
        name: "মোস্তাফিজুর রহমান", batch: "ওয়েব ডেভেলপমেন্ট — ব্যাচ ১", initials: "মর",
        ...
        achievement: "ফ্রিল্যান্স ওয়েব ডেভেলপার", color: "#6A1B9A",
    },
    {
        name: "আবু বকর সিদ্দিক", batch: "ড্রাইভিং ট্রেনিং — ব্যাচ ৫", initials: "আস",
        ...
        achievement: "পেশাদার ড্রাইভার", color: "#2E7D32",
    },
];
            ...
            <section className={styles.pageHeader}>
                ...
                <div className={`container ${styles.pageHeaderContent}`}>
                    <span className="section-badge section-badge-dark">
                        <MessageCircleIcon size={14} color="var(--color-secondary-400)" />
                        সাফল্যের গল্প
                    </span>
                    <h1 className="heading-lg" style={{ color: "white" }}>
                        যারা বদলেছেন <span className="gradient-text">নিজেদের ভাগ্য</span>
                    </h1>
                    <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: "600px", fontSize: "var(--text-lg)" }}>
                        আমাদের শিক্ষার্থীরা কিভাবে প্রশিক্ষণ নিয়ে জীবন বদলে দিয়েছেন
                    </p>
                </div>
            </section>
            ...
            <section className={`section ${styles.storiesSection}`}>
                <div className="container">
                    <div className={styles.storiesGrid}>
                        {stories.map((s, i) => (
                            <div key={i} className={styles.storyCard} style={{ borderTopColor: s.color }}>
                                ...
                                <div className={styles.storyAchievement} style={{ background: `${s.color}10`, color: s.color }}>
                    ...
                    <div className={styles.storiesCta}>
                        ...
                        <Link href="/contact" className="btn btn-primary">গল্প শেয়ার করুন</Link>
                    </div>
                </div>
            </section>
        </>
